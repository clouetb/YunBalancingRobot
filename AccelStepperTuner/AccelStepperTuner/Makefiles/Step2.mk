...
#
#
# Last update: Nov 26, 2013 release 116
...
debug: 		make message_debug reset serial raw_upload launch_debug end_debug
...
# Debug 2: Launch the client
		...
		@sleep 5
		@echo "Launch client"
		osascript -e 'tell application "Terminal" to do script "$(GDB) -x $(UTILITIES_PATH)/gdb.txt"'
